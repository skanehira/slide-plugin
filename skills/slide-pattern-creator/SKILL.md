...
カレントディレクトリに `SLIDE-PATTERN-{name}/` フォルダを作成して保存する：

    SLIDE-PATTERN-{name}/SLIDE-PATTERN-{name}.md
...
---
出力ファイル：SLIDE-PATTERN-{name}/SLIDE-PATTERN-{name}.md
...
### 出力先
    ...
    SLIDE-PATTERN-{name}/SLIDE-PATTERN-{name}.html
