...
カレントディレクトリに無い場合、このSKILL.mdから見て `../../docs/SLIDE-md/SLIDE-md-*/SLIDE.md`（プラグイン同梱の10種類のサンプルデザインシステム）を検索する。

**見つかった場合：**

各ファイルのOverview（マッチするシーン）を読み取って以下の形式で提示する：

> 「カレントディレクトリにはデザインシステムが見つかりませんでしたが、プラグイン同梱のサンプルデザインシステムが10種類あります。どれを使いますか？番号で教えてください。
>
